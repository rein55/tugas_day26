...
class ModelTrainer:
    ...
    def __init__(self, experiment_name: str = "houseprice_prediction"):
        """
        ...
        try:
            ...
            with mlflow.start_run(run_name=model_type, nested=True) as run:
                ...
                mlflow.sklearn.log_model(
                    model,
                    model_type,
                    registered_model_name=f"houseprice_prediction_{model_type}"
                )
    ...
    def _select_best_model(self) -> None:
        ...
        try:
            ...
            if best_model_type:
                ...
                model_name = f"houseprice_prediction_{best_model_type}"
